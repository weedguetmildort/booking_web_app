...
function UserCalendar() {
    ...
    function prepareBookings() {
        ...
        // a fully booked day
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T14:00:00.000Z"),duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T15:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T16:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T17:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T18:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T19:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T20:00:00.000Z"), duration2));
        the1stBookingDay.insertBooking(new Booking(new Date("2024-08-01T21:00:00.000Z"), duration2));

        let testBookings = the30thBookingDay.getBookings();

        allBookingDays.set(the30thBookingDay.date.toDateString(), the30thBookingDay);
        allBookingDays.set(the31thBookingDay.date.toDateString(), the31thBookingDay);
