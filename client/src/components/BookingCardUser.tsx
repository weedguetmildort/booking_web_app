...
function BookingCardUser(info: { userID, partnerID, bookingID, bookingDate, bookingStartTime, bookingDuration, bookingEndTime, serviceName, serviceDescription, businessName }) {
